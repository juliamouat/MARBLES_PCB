...
setwd("/share/lasallelab/Jules/MARBLES_PCB/Females_Males/V2")
...
#Load V1 Modules and V2 sample table##
setwd("/share/lasallelab/Jules/MARBLES_PCB/Females_Males/V2")
modules <- readRDS("/share/lasallelab/Jules/MARBLES_PCB/Females_Males/V1/Modules.rds")
regions <- modules$regions
colData <- read.xlsx("/share/lasallelab/Jules/MARBLES_PCB/Females_Males/V2/Sample_Info_V2.xlsx", rowNames = TRUE)
MEs <- modules$MEs
