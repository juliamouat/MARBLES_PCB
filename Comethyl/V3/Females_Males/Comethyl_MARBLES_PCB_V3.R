...
##minModuleSize changed from 10 to 30 to try to reduce number of modules formed 
...
setwd("/share/lasallelab/Jules/MARBLES_PCB/Females_Males/V3")
...
colData <- read.xlsx("Sample_Info_V3.xlsx", rowNames = TRUE)
setwd("/share/lasallelab/Jules/MARBLES_PCB/placenta_cytosine_reports")
bs <- getCpGs(colData, file = "Unfiltered_BSseq.rds")
# move Unfiltered.BSseq.rds to /share/lasallelab/Jules/MARBLES_PCB/Females_Males/V3
setwd("/share/lasallelab/Jules/MARBLES_PCB/Females_Males/V3")
...
#Setup Epigenerate#
modules <- readRDS("/share/lasallelab/Jules/MARBLES_PCB/Females_Males/V3/Modules.rds")
regions <- modules$regions
colData <- read.xlsx("/share/lasallelab/Jules/MARBLES_PCB/Females_Males/V3/Sample_Info_V3.xlsx")
MEs <- modules$MEs

# Annotate Modules ####
regionsAnno <- annotateModule(regions, module = c("lightcyan"), genome = "hg38",
                              file = "Annotated_lightcyan_Module_Regions.txt")
regionsAnno <- annotateModule(regions, module = c("lightcyan", "red", "purple", "tan", "royalblue", "green", 
                                                  "magenta", "grey60", "salmon", "cyan", "lightyellow", "midnightblue", 
                                                  "black", "yellow", "turquoise", "greenyellow", "pink", "blue", 
                                                  "brown", "lightgreen"), genome = "hg38",
...
enrich_lightcyan <- enrichModule(regions, module = "lightcyan", genome = "hg38", file = "Lightcyan_Module_Enrichment.txt")
enrich_red <- enrichModule(regions, module = "red", genome = "hg38", file = "Red_Module_Enrichment.txt")
enrich_all <- enrichModule(regions, module = c("lightcyan", "red", "purple", "tan", "royalblue", "green", 
                                               "magenta", "grey60", "salmon", "cyan", "lightyellow", "midnightblue", 
                                               "black", "yellow", "turquoise", "greenyellow", "pink", "blue", 
                                               "brown", "lightgreen"), genome = "hg38", file = "Module_Enrichment.txt")
plotEnrichment(enrich_lightcyan, file= "Lightcyan_Module_Enrichment.pdf")
