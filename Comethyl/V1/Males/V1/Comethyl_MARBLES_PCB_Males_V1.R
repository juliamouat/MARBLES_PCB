...
setwd("/share/lasallelab/Jules/MARBLES_PCB/Males/V1")
...
colData <- read.xlsx("Sample_Info_Males_V1.xlsx", rowNames = TRUE)
setwd("/share/lasallelab/Jules/MARBLES_PCB/placenta_cytosine_reports/Males")
bs <- getCpGs(colData, file = "Unfiltered_BSseq.rds")
# move Unfiltered.BSseq.rds to /share/lasallelab/Jules/MARBLES_PCB/Males/V1
setwd("/share/lasallelab/Jules/MARBLES_PCB/Males/V1")
