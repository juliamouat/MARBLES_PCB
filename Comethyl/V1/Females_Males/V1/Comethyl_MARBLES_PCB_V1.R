...
setwd("/share/lasallelab/Jules/MARBLES_PCB/Females_Males/V1")
...
colData <- read.xlsx("Sample_Info_V1.xlsx", rowNames = TRUE)
setwd("/share/lasallelab/Jules/MARBLES_PCB/placenta_cytosine_reports")
bs <- getCpGs(colData, file = "Unfiltered_BSseq.rds")
# move Unfiltered.BSseq.rds to /share/lasallelab/Jules/MARBLES_PCB/Females_MalesV1
setwd("/share/lasallelab/Jules/MARBLES_PCB/Females_Males/V1")
...
# Filter Regions ####
regions <- filterRegions(regions, covMin = 20, methSD = 0.07, file = "Filtered_Regions.txt")
...
#Setup Epigenerate#
modules <- readRDS("share/lasallelab/Jules/MARBLES_PCB/Females_Males/V1/Modules.rds")
regions <- modules$regions
colData <- read.xlsx("/share/lasallelab/Jules/MARBLES_PCB/Females_Males/V1/Sample_Info_V1.xlsx")
MEs <- modules$MEs

# Annotate Modules ####
regionsAnno <- annotateModule(regions, module = c("paleturquoise"), genome = "hg38",
                              file = "Annotated_paleturquoise_Module_Regions.txt")
(geneList_paleturquoise <- getGeneList(regionsAnno, module = "paleturquoise"))
regionsAnno <- annotateModule(regions, module = c("darkolivegreen"), genome = "hg38",
                              file = "Annotated_darkolivegreen_Module_Regions.txt")
(geneList_darkolivegreen <- getGeneList(regionsAnno, module = "darkolivegreen"))
regionsAnno <- annotateModule(regions, module = c("darkorange2"), genome = "hg38",
                              file = "Annotated_darkorange2_Module_Regions.txt")
(geneList_darkorange2 <- getGeneList(regionsAnno, module = "darkorange2"))

regionsAnno <- annotateModule(regions, module = c("black", "blue", "brown", "cyan", "darkgreen", "darkgrey", "darkmagenta", "darkolivegreen",
                                                  "darkorange", "darkorange2", "darkred", "darkturquoise", "floralwhite", "green",
                                                  "greenyellow", "grey", "grey60", "ivory", "lightcyan", "lightcyan1", "lightgreen", 
                                                  "lightsteelblue1", "lightyellow", "magenta", "mediumpurple3", "midnightblue", "orange",
                                                  "orangered4", "paleturquoise", "pink", "plum1", "purple", "red", "royalblue", "saddlebrown", 
                                                  "salmon", "sienna3", "skyblue", "skyblue3", "steelblue", "tan", "turquoise", "violet", "white", 
                                                  "yellow", "yellowgreen"), genome = "hg38",
                              file = "Annotated__Module_Regions.txt")

# Plot Module Eigennodes vs Traits
plotMEtraitScatter(MEs$red, trait = colData$ADOScs, ylim = c(-0.15,0.15), xlab = "ADOScs", 
                   ylab = "Red Module Eigennode", file = "Red_ME_ADOScs_Scatterplot.pdf")


# Analyze Functional Enrichment ####
(ontologies <- listOntologies("hg38", version = "4.0.4"))
enrich_red <- enrichModule(regions, module = "red", genome = "hg38", file = "Red_Module_Enrichment.txt")
